...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='系统-授权';

-- ----------------------------
-- Records of system_auth_node
-- ----------------------------
BEGIN;
INSERT INTO `system_auth_node` VALUES (73, 2, 'data');
INSERT INTO `system_auth_node` VALUES (74, 2, 'data/user');
INSERT INTO `system_auth_node` VALUES (75, 2, 'data/user/server');
COMMIT;
...
CREATE TABLE `system_oplog` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='系统-日志';
...
INSERT INTO `system_oplog` VALUES (86, 'admin/login/index', '192.168.112.1', '系统用户登录', '登录系统后台成功', 'admin', '2021-01-20 21:21:39');
INSERT INTO `system_oplog` VALUES (87, 'admin/api.plugs/pushruntime', '192.168.112.1', '系统运维管理', '刷新并创建网站路由缓存', 'admin', '2021-01-20 21:24:32');
INSERT INTO `system_oplog` VALUES (88, 'admin/api.plugs/clearruntime', '192.168.112.1', '系统运维管理', '清理网站日志及缓存数据', 'admin', '2021-01-20 21:24:36');
INSERT INTO `system_oplog` VALUES (89, 'admin/user/edit', '192.168.112.1', '用户管理', '修改系统用户[10005]成功', 'admin', '2021-01-20 23:51:17');
INSERT INTO `system_oplog` VALUES (90, 'admin/user/edit', '192.168.112.1', '用户管理', '修改系统用户[10005]成功', 'admin', '2021-01-20 23:56:38');
INSERT INTO `system_oplog` VALUES (91, 'admin/user/add', '192.168.112.1', '用户管理', '添加系统用户[10006]成功', 'admin', '2021-01-20 23:56:59');
INSERT INTO `system_oplog` VALUES (92, 'admin/user/edit', '192.168.112.1', '用户管理', '修改系统用户[10006]成功', 'admin', '2021-01-20 23:57:30');
INSERT INTO `system_oplog` VALUES (93, 'admin/auth/apply', '192.168.112.1', '系统权限管理', '配置系统权限[1]授权成功', 'admin', '2021-01-20 23:57:45');
INSERT INTO `system_oplog` VALUES (94, 'admin/auth/apply', '192.168.112.1', '系统权限管理', '配置系统权限[2]授权成功', 'admin', '2021-01-20 23:57:59');
INSERT INTO `system_oplog` VALUES (95, 'admin/login/index', '192.168.112.1', '系统用户登录', '登录系统后台成功', 'qqq1312', '2021-01-20 23:58:17');
INSERT INTO `system_oplog` VALUES (96, 'admin/login/index', '192.168.112.1', '系统用户登录', '登录系统后台成功', 'admin', '2021-01-21 00:03:51');
INSERT INTO `system_oplog` VALUES (97, 'admin/auth/apply', '192.168.112.1', '系统权限管理', '配置系统权限[2]授权成功', 'admin', '2021-01-21 00:04:18');
INSERT INTO `system_oplog` VALUES (98, 'admin/auth/apply', '192.168.112.1', '系统权限管理', '配置系统权限[1]授权成功', 'admin', '2021-01-21 00:04:29');
INSERT INTO `system_oplog` VALUES (99, 'admin/login/index', '192.168.112.1', '系统用户登录', '登录系统后台成功', 'qqq1312', '2021-01-21 00:05:31');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='系统-用户';

-- ----------------------------
-- Records of system_user
-- ----------------------------
BEGIN;
INSERT INTO `system_user` VALUES (10000, 'admin', '21232f297a57a5a743894a0e4a801fc3', '系统管理员', 'http://localhost/upload/56/0d71e775fb29b354c939d974f5394b.jpg', ',,', '', '', '', '192.168.112.1', '2021-01-21 00:03:51', 70, '', 1, 0, 0, '2015-11-13 15:14:22', 8000, '12345678', '', 100000, '2021-01-31 00:00:00', 'q8zgiwecn6');
...
INSERT INTO `system_user` VALUES (10006, 'qqq1312', 'd4832f679a2efcc5d1e8643f43f4dc53', 'qqq1312', '', ',2,', '', '', '', '192.168.112.1', '2021-01-21 00:05:31', 2, '', 1, 0, 0, '2021-01-20 23:56:59', NULL, '', '', NULL, NULL, 'tvp9ck5mycvl');
COMMIT;
